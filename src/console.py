...
def result(input, model_prediction, model_certainty, moving_windows_scores, train_times, test_times, final_train_time):
    ...
    print(f"Prediction for {input.index[0].date() + pd.offsets.BDay(1)} "
        f"= {prediction_text} "
